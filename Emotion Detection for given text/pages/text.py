...
def app():
    ...
    with col2:
        ...
        translation_lang = st.selectbox(
            'Choose translation language', help='Choose the language you want to translate the speech to', options=page_names)
    ...
    if text:
        ...
        if st.button(f"Translate in {full_lang}"):
            ...
            save_audio(text_output, translation_lang,
                       slow_audio_speed, filename_translated)
        ...
        if st.button("Summarize"):
            ...
            audio_created = save_audio(
                summary_result, language, slow_audio_speed, filename)
            read_audio(filename)
